...
JS := static/js/lib/chunks/helpers.segment.js static/js/lib/chart.js static/js/lib/luxon.js static/js/lib/chartjs-adapter-luxon.esm.js $(wildcard static/js/*.js)
DOCS := static/docs/openapi.bundle.json
...
OPENAPI_SOURCES := $(wildcard static/docs/*.yaml) $(wildcard static/docs/paths/*.yaml) $(wildcard static/docs/schemas/*.yaml)

static/docs/openapi.bundle.json: openapi/bundle.cr $(OPENAPI_SOURCES)
	crystal run openapi/bundle.cr -- static/docs/openapi.yaml $@
